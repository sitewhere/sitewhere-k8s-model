...
/**
 * TenantDatasetTemplate CRD specification.
 */
@JsonDeserialize(using = JsonDeserializer.None.class)
public class TenantDatasetTemplateSpec implements KubernetesResource {

    /** Serial version UID */
    private static final long serialVersionUID = -8758591030493727519L;
